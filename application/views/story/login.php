...
<?php if($cover_image != null) { ?> <img src="<?php echo base_url()."assets/page_images/mobile/".$cover_image['mobile_uri'] ?>" alt="Story Logo" class="img-responsive cover-image"/> <?php  } ?>
